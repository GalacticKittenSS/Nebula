...
namespace Nebula {
	...
	#define NB_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Nebula::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Nebula::InstrumentationTimer timer##line(fixedName##line.Data)
	#define NB_PROFILE_SCOPE_LINE(name, line) NB_PROFILE_SCOPE_LINE2(name, line)
	#define NB_PROFILE_SCOPE(name) NB_PROFILE_SCOPE_LINE(name, __LINE__)
